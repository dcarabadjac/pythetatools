...
nuflav_to_xlabel = {'numu':'Energy [GeV]', 'nue': 'Electron momentum [MeV]'}
nuflav_to_xtickspos = {'numu':np.arange(0, 3.5, 0.5), 'nue': np.arange(0, 1300, 200)}
nuflav_to_xmax = {'numu':3, 'nue': 1300}
